            ...
            <Row className='row-grid justify-content-between'>
              ...
              <Col md='6'>
                <div className='px-md-5'>
                  ...
                  <p>
                    The design system comes with three pre-built pages to help you get started faster. You can change the text and images and you're
                    good to go.
                  </p>
          ...
          <Container>
            <Row>
              <Col md='4'>
                <hr className='line-info' />
                <h1>
                  Choose the coin <span className='text-info'>that fits your needs</span>
                </h1>
              </Col>
            </Row>
            <Row>
              ...
              <Col md='4'>
                <Card className='card-coin card-plain'>
                  <CardHeader>
                    <img alt='...' className='img-center img-fluid' src={require('../../assets/img/ripp.png').default} />
                  </CardHeader>
                  <CardBody>
                    <Row>
                      <Col className='text-center' md='12'>
